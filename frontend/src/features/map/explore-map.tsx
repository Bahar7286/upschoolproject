    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <p className="text-sm text-stone-600 dark:text-stone-400">
          ...
          <strong>OpenStreetMap</strong> (Türkiye WGS84). Müze, saray, yemek ve konaklama pinleri veri katmanından gelir.
        ...
        <div className="inline-flex rounded-full border border-stone-900/10 bg-white/70 p-1 shadow-sm backdrop-blur dark:border-white/10 dark:bg-zinc-900/70">
          ...
          <button
            ...
            className={`tap-scale min-h-[44px] rounded-full px-4 py-2 text-sm font-semibold transition ${
              ...
              engine === 'leaflet' ? 'bg-heritage-ink text-white shadow dark:bg-stone-100 dark:text-heritage-ink' : 'text-stone-600 dark:text-stone-400'
      ...
      {engine === 'google' && googleKey ? (
        ...
        <GoogleExploreMap routes={routes} apiKey={googleKey} />
