...
export function GoogleVenuePlaceCard({
  placeId,
  name,
  category,
  subtitle,
  ...
  const img = resolveGooglePlaceImage(photoUrl, name);

  return (
    <Link
      to={to}
      className="tap-scale group block overflow-hidden rounded-2xl border border-stone-900/8 bg-white shadow-sm dark:border-white/10 dark:bg-zinc-900"
    >
